...
#ifndef RANGEPILOT_SWIFT_H
#define RANGEPILOT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RangePilot",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
SWIFT_CLASS("_TtC10RangePilot34CurrentLocationRouteOriginProvider")
...
SWIFT_CLASS("_TtC10RangePilot24RangeMapLocationProvider")
