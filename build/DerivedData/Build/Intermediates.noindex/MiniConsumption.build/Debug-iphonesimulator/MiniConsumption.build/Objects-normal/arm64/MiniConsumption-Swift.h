...
#ifndef MINICONSUMPTION_SWIFT_H
#define MINICONSUMPTION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MiniConsumption",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
SWIFT_CLASS("_TtC15MiniConsumption34CurrentLocationRouteOriginProvider")
@interface CurrentLocationRouteOriginProvider : NSObject <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC15MiniConsumption24RangeMapLocationProvider")
@interface RangeMapLocationProvider : NSObject <CLLocationManagerDelegate>
