...
* Continuous calibration from logged trips
* Local-first privacy
...
* adjust driving conditions realistically
* remember that motorway driving increases consumption significantly
* log a few longer real-world trips
* enable Continuous calibration to adapt estimates to your driving patterns
* consider using Cautious mode during winter or longer drives
